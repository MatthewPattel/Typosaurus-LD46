...
butPlay = instance_create_layer(wd*6, hd*6, "Instances", obj_button_rectangle);
with (butPlay) {
	text = "PLAY";
	scale = 2;
...
butDiff = instance_create_layer(wd*6, hd*8, "Instances", obj_button_rectangle);
with (butDiff) {
...
butExit = instance_create_layer(wd*6, hd*10, "Instances", obj_button_rectangle);
with (butExit) {
	text = "EXIT";
	scale = 2;
	button_font = fnt_game_small;
